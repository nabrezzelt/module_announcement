        ...
        for ($announcements->rewind(); $announcements->valid(); $announcements->next())
        {
            ...
            echo " <tr>
                    ...
                    <td><a  class='btn btn-success " . (($announcement->isActive()) ? 'disabled' : '') . "'
                            href='" . $this->getUrl(['controller' => 'index', 'action' => 'activate', 'id' => $id]) . "'>Activate</a>
                        <a  class='btn btn-warning'
                            href='" . $this->getUrl(['controller' => 'index', 'action' => 'edit', 'id' => $id]) . "'>Edit</a>
                        <a  class='btn btn-danger'
                            href='" . $this->getUrl(['controller' => 'index', 'action' => 'delete', 'id' => $id]) . "'>Delete</a></td>
                </tr>";
        }
